...
def datafr():
    df= pd.read_csv("C:/Users/Admin/Desktop/Airbnb project/Airbnb.csv")
    return df
...
if select == "Home":
    ...
    image1= Image.open("C:/Users/Admin/Desktop/Airbnb project/Screenshot (11).png")
    st.image(image1)
...
if select == "Data Exploration":
    ...
    with tab2:
        ...
        def datafr():
            df_a= pd.read_csv("C:/Users/Admin/Desktop/Airbnb project/Airbnb.csv")
            return df_a
    ...
    with tab5:
        ...
        with col1:
            ...
            fig_price= px.bar(df_price, x= "Total_price", y= "host_neighbourhood", orientation='h',
                            title= "PRICE BASED ON HOST_NEIGHBOURHOOD", width= 500, height= 700)
            st.plotly_chart(fig_price)

        with col2:

            fig_price_2= px.bar(df_price, x= "Avarage_price", y= "host_neighbourhood", orientation='h',
                                title= "AVERAGE PRICE BASED ON HOST_NEIGHBOURHOOD",width= 500, height= 700)
